...
import com.nuange.community.entity.*;
...
public class DiscussPostController implements CommunityConstant {
    ...
    public String addDiscussPost(String title, String content) {
        ...
        if (user == null) {
            return CommunityUnity.getJSONString(403, "您还没有登录");
        }
    ...
    public String getDiscussPost(@PathVariable("discussPostId") int id, Model model, Page page) {
        ...
        //作者
        User user = userService.findUserById(discussPostByid.getUserId());
        ...
        //回复：给评论的评论
        //评论列表
        List<Comment> commentList = commentService.findCommentByEntity(CommunityConstant.ENTITY_TYPE_POST, discussPostByid.getId(), page.getOffset(), page.getLimit());
